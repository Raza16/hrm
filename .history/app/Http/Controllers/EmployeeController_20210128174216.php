...
class EmployeeController extends Controller
{
    ...
    public function create()
    {
        ...
        if(!$so){
            $newSaleId = "EMP-000001";
            return view('backend.employee.create', compact('products', 'customers', 'newSaleId'));
        }

        $lastSaleID = DB::table('sales')->orderBy('id', 'desc')->pluck('order_no')->first();
        $prefix = "SO-";
