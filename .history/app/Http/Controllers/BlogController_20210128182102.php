...
class BlogController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            ...
            'featured_image' => 'required|image|mimes:jpeg,png,jpg|dimensions:width=1100,height=550',
    ...
    public function update(Request $request, $id)
    {
        $this->validate($request, [
            ...
            'description' => 'required',
            'featured_image' => 'image|mimes:jpeg,png,jpg|dimensions:width=1100,height=550',
            'author' => 'required|max:255',
        ...
        if ($request->hasFile('featured_image')) {
            ...
            // "for-image" is a custom disk name in config/filesystems.php
            Storage::disk('for-image')->delete($old_image);
        }
