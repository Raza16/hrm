...
class TaskController extends Controller
{
    ...
    public function getDownload($id)
    {
        ...
        // $file = public_path('file_storage/task_files/1612963105_TECHataCLICK Release Notes_7_ FEB.docx ');
        // // dd($file);
        ...
        $file = public_path()."/file_storage/task_files/file.txt";
        ...
        // dd($file);
            ...
            // return Storage::get($file, 'info.txt' ,$headers);
            return Response::download('task-attachment')->get($file);
