                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-options">
                                            ...
                                            <a class="btn btn-sm btn-secondary mr-1" href="{{url('user/create')}}">Add User</a>
                                        </div>
                                    </div>
                                        ...
                                        <table class="datatable table table-striped table-bordered" style="width:100%">
                                            ...
                                            <tbody class="table-hover ">
                                                @foreach ($users as $user)
                                                    <tr>
                                                        <td>{{$user->employee->first_name. $user->middle_name. $user->last_name}}</td>
                                                        ...
                                                        <td>
                                                            <div style="margin-bottom:-9px;display:flex;" class="option-btn">
                                                                ...
                                                                <a href="{{url('user/'.$user->id.'/edit')}}" class="btn btn-sm btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> &nbsp;
                                                                </a>
