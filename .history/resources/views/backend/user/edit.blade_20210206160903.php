                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="employee_id">
                                                        ...
                                                        @foreach ($employees as $employee)
                                                            <option value="{{$employee->id}} {{$user->employee_id == $user->employee_id ? 'selected' : ''}}">{{$employee->first_name." ".$employee->middle_name." ".$employee->last_name}}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('employee_id')
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="status" value="1" {{$status == 1 ? 'checked' : ''}} >Active</label>
                                                        </div>
                                                        <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="status" value="0" {{$status == 0 ? 'checked' : ''}}>Inactive</label>
                                                        </div>
                                                    @error('status')
