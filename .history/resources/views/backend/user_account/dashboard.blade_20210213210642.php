                                ...
                                <div class="card">
                                    <div class="card-body widgets1">
                                        ...
                                        <div class="details">
                                            ...
                                            <span class="mb-0">
                                                <time class="click-timer" id="clock-timer"><input type="text" value="0:00:00.00"/></time>
                                                <button class="ct" id="clock-toggle">start</button>
                                                <button class="cc" id="clock-clear">clear</button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
