                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="from_date" class="form-control" value="{{old('from_date')}}">
                                                    @error('from_date')
                                                ...
                                                <div class="form-group">
                                                    <label>To Date</label>
                                                    <input type="text" name="to_date" class="form-control" value="{{old('to_date')}}">
                                                    @error('to_date')
                                                ...
                                                <div class="form-group">
                                                    <label>Reason</label>
                                                    <textarea type="text" name="reason" class="form-control" value="{{old('reason')}}"></textarea>
                                                    @error('reason')
