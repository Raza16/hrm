   ...
   <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-12">
                        ...
                        <div class="card-body">
                            <h3 class="card-title" style="font-size:20px;"><b>{{$employee->first_name." ".$employee->middle_name." ".$employee->last_name}}</b></h3>
                            <span style="font-size:15px;">{{$employee->employee_no}}</span>
