                    ...
                    <div class="col-lg-4 col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p>National ID Card No {{$employee->cnic}}</p>
                                <p>Home Phone {{$employee->home_phone}}</p>
                                <p>Emergency Contact {{$employee->emergency_contact}}</p>
                                <p>Other Email {{$employee->other_email}}</p>
                                <p>Nationality {{$employee->nationality}}</p>
                                <p>Postal/Zip Code {{$employee->postal_code}}</p>
