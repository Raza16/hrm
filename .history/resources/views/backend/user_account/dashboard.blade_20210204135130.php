   ...
   <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <img class="card-img-top" src="{{asset('img/profile-images/'.Auth::user()->employee->profile_image)}}" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">{{Auth::user()->employee->first_name." ".Auth::user()->employee->middle_name." ".Auth::user()->employee->last_name}}</h5>
