                                            ...
                                            <tbody class="table-hover ">
                                                @foreach ($tasks as $task)
                                                    <tr>
                                                        ...
                                                        <td>{{$task->status}}</td>
                                                        <td>
                                                            <a href="{{url('employee-task/'.$task->taskId)}}">{{$task->document}}</a>
                                                        </td>
                                                        <td>
                                                            <div style="margin-bottom:-9px;display:flex;" class="option-btn">
                                                                ...
                                                                <a href="{{url('employee-task/'.$task->taskId.'/edit')}}" class="btn btn-sm btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> &nbsp;
                                                                </a>
                                                            </div>
                                                        </td>
                                                    </tr>
