...
@section('title', 'DATech | Blog | List')
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-options">
                                            ...
                                            <a class="btn btn-sm btn-secondary mr-1" href="{{url('cms/blog/create')}}">Add Blog</a>
                                        </div>
                                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div style="margin-bottom:-9px;display:flex;" class="option-btn">
                                                                ...
                                                                <a href="{{url('/cms/blog/'.$blog->id.'/edit')}}" class="btn btn-sm btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
</a>
                                                                ...
                                                                <form action="{{ url('/cms/blog/'.$blog->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
