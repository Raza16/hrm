...
@section('title', 'DATech | Blog | Edit')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <form class="card-body" action="{{url('cms/blog/'.$blog->id)}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="4" name="description" class="form-control no-resize" placeholder="description...">{{ $blog->description }}</textarea>
                                                    @error('description')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="4" name="meta_description" class="form-control no-resize" placeholder="description...">{{ $blog->meta_description }}</textarea>
                                                ...
                                                <div class="form-group">
                                                    {{-- <div class="custom-file-container" data-upload-id="myUniqueUploadId">
                                                        ...
                                                        <label class="custom-file-container__custom-file">
                                                            <input type="file" name="featured_image" class="custom-file-container__custom-file__custom-file-input" accept="image/jpeg, image/jpg, image/png" aria-label="Choose File" 
                                                            />
                                                        ...
                                                        @enderror
                                                        <div class="custom-file-container__image-preview" style="border:1px solid;"></div>
                                                    </div> --}}
                                                    <label>Featured Image</label>
                                                    <div style="width:469px; border:1px solid #d9dee4;">
                                                        <img style="max-width:469px;max-height:250px;
                                                        display:block;" class="featured-image" src="{{asset('img/blogs/'.$blog->featured_image)}}"/>
