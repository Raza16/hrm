...
@section('title', 'DATech | Blog | Create')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <form class="card-body" action="{{url('cms/blog')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="2" id="editor" name="description" class="form-control no-resize" placeholder="description...">{{ old('description') }}</textarea>
                                                    @error('description')
                                            ...
                                            <div class="col-md-6 col-sm-12 second-column">
                                                <div class="form-group">
                                                    ...
                                                    <div style="width:469px; border:1px solid #d9dee4;">
                                                        ...
                                                        display:block;" class="featured-image" src="https://via.placeholder.com/468x250?text=680+x+250"/>
