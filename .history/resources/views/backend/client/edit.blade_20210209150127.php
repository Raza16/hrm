                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <form class="card-body" action="{{url('client/'.$client->id)}}" method="post">
                                        @method('PUT')
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="full_name" class="form-control" value="{{$client->full_name}}">
                                                    @error('full_name')
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="gender" value="male" {{$client->gender == 'male' ? 'checked' : ''}}>Male
                                                        </label>
                                                        </div>
                                                        <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input"name="gender" value="female" {{$client->gender == 'female' ? 'checked' : ''}}>Female
                                                        </label>
                                                        </div>
                                                    @error('gender')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="mobile_no" class="form-control" value="{{$client->mobile_no}}">
                                                    @error('mobile_no')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="state_province" class="form-control" value="{{$client->state_province}}">
