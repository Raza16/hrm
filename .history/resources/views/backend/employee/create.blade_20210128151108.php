                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @error('emergency_contact_no')
                                                        <p><small class="text-danger">{{ $errors->first('emergency_contact_no') }}</small></p>
                                                    @enderror
                                                </div>
                                                <div class="form-group">
                                                    <label>Email</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="alternative_email" class="form-control" value="{{ old('alternative_email') }}"/>
                                                    @error('alternative_email')
                                                        <p><small class="text-danger">{{ $errors->first('alternative_email') }}</small></p>
                                                    @enderror
                                                </div>
                                            ...
                                            <h6>Employee Address</h6>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @error('province')
                                                        <p><small class="text-danger">{{ $errors->first('province') }}</small></p>
                                                    @enderror
                                                </div>
                                                <div class="form-group">
                                                    <label>City</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div style="width:250px; border:1px solid #d9dee4;">
                                                        ...
                                                        <button type="button" style="background:#d9dee4; border-radius:0px;width:250px;cursor:pointer;font-size:12px;font-weight:600;" class="upload-button btn btn-default"><i style="font-size:14px;" class="fa fa-upload" aria-hidden="true"></i> &nbsp;Upload Image</button>
