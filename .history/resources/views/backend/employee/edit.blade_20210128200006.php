                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="date_of_birth" class="form-control" value="{{ $employee->date_of_birth }}">
                                                    @error('date_of_birth')
                                            ...
                                            <h6>Employee Address</h6>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div style="width:200px; border:1px solid #d9dee4;">
                                                        ...
                                                        display:block;" class="for-image" src="{{ url('img/profile-images/').$employee->profile_image }}"/>
