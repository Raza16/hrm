                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="first_name" class="form-control no-resize">{{ old('first_name') }}</textarea>
                                                    @error('first_name')
                                                ...
                                                <div class="form-group">
                                                    <label>Gender</label>
                                                    <textarea rows="4" name="gender" class="form-control no-resize" placeholder="description...">{{ old('gender') }}</textarea>
                                                    @error('gender')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" rows="4" name="mobile_no" class="form-control no-resize" placeholder="description...">{{ old('mobile_no') }}</textarea>
                                                    @error('mobile_no')
