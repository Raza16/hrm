                                    ...
                                    <form class="card-body" action="{{url('employee')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    <label>Gender</label>
                                                    {{-- <input type="radio" name="gender" class="form-control" value="{{ old('gender') }}"/> --}}
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label" for="radio1">
                                                            <input type="radio" class="form-check-input" id="radio1" name="optradio" value="gender" checked>Male
                                                        </label>
                                                        </div>
                                                        <div class="form-check-inline">
