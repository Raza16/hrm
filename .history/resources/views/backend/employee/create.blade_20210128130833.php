                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="first_name" class="form-control no-resize" placeholder="First name...">{{ old('First name') }}</textarea>
                                                    @error('First name')
                                                        <p><small class="text-danger">{{ $errors->first('First name') }}</small></p>
                                                    @enderror
                                                </div>
                                                <div class="form-group">
                                                    <label>Author</label>
