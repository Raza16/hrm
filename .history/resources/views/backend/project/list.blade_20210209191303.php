                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-options">
                                            ...
                                            <a class="btn btn-sm btn-secondary mr-1" href="{{url('project/create')}}">Add Project</a>
                                        </div>
                                    </div>
                                            ...
                                            <tbody class="table-hover ">
                                                @foreach ($projects as $project)
                                                    <tr>
                                                        ...
                                                        @endif
                                                        {{$project->client['full_name']}}</td>
                                                        <td>{{$project->title}}</td>
                                                        <td>{{$project->start_date}}</td>
                                                        <td>{{$project->end_date}}</td>
                                                        <td>
                                                            @if ($project->status == 'pending')
                                                                <span class="tag tag-warning ml-0 mr-0">{{$project->status}}</span>
                                                            @elseif($project->status == 'process')
                                                                <span class="tag tag-primary ml-0 mr-0">{{$project->status}}</span>
                                                            @elseif($project->status == 'completed')
                                                                <span class="tag tag-success ml-0 mr-0" style="background-color:#21ba45">{{$project->status}}</span>
                                                            @elseif($project->status == 'terminated')
                                                                <span class="tag tag-success ml-0 mr-0">{{$project->status}}</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            <div style="margin-bottom:-9px;display:flex;" class="option-btn">
                                                                ...
                                                                <a href="{{url('project/'.$project->id.'/edit')}}" class="btn btn-sm btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> &nbsp;
                                                                </a>
