                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <form class="card-body" action="{{url('project/'.$project->id)}}" method="post">
                                        @method('PUT')
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @error('start_date')
                                                        <p><small class="text-danger">{{ $errors->first('start_date') }}</small></p>
                                                    @enderror
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    @error('end_date')
                                                        <p><small class="text-danger">{{ $errors->first('end_date') }}</small></p>
                                                    @enderror
                                                </div>
                                                <div class="form-group">
                                                    <label>status</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="technology" class="form-control" value="{{$project->technology}}">
                                                    @error('technology')
                                                        <p><small class="text-danger">{{ $errors->first('technology') }}</small></p>
                                                    @enderror
                                                </div>
                                                <div class="form-group">
                                                    <label>Website</label>
                                                ...
                                                <div class="form-group">
                                                    <label>Note</label>
                                                    <textarea rows="6" class="form-control">{{$project->note}}</textarea>
                                                    @error('note')
