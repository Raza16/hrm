    ...
    <div id="left-sidebar" class="sidebar ">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{url('project')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>All Task</a></li>
                    <li><a href="{{url('project/create')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>Add Task</a></li>
                </ul>
            </li>
