    ...
    <div id="left-sidebar" class="sidebar ">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{url('client/list')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>
Client List</a></li>
                    <li><a href="{{url('client/create')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>
Create Client</a></li>
                </ul>
            </li>
            ...
            <li>
                <a href="javascript:void(0)" class="has-arrow arrow-c"><i class="fa fa-lock"></i><span>Employees</span></a>
                <ul>
                    <li><a href="{{url('employee/list')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>Employees List</a></li>
                    <li><a href="{{url('employee/create')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>Employees Create</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{url('employee/list')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>User List</a></li>
                    <li><a href="{{url('employee/create')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>User Create</a></li>
                </ul>
            </li>
