...
<div id="main_content">
    ...
    <div id="left-sidebar" class="sidebar ">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            ...
            {{-- <li><a href="#"><i class="fa fa-list-ol"></i><span>Clients</span></a></li> --}}

            {{-- <li>
                <a href="javascript:void(0)" class="has-arrow arrow-c"><i class="fa fa-lock"></i><span>Clients</span></a>
                <ul>
                    <li><a href="{{url('client/list')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>Client List</a></li>
                    <li><a href="{{url('client/create')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>Create Client</a></li>
                </ul>
            </li> --}}
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{url('employee')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>Employee List</a></li>
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{url('user')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>User List</a></li>
                    <li><a href="{{url('employee/create')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>Add User</a></li>
                </ul>
            </li>

            <li>
                <a href="javascript:void(0)" class="has-arrow arrow-c"><i class="fa fa-lock"></i><span>Uesr Role</span></a>
                <ul>
                    <li><a href="{{url('role')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>User List</a></li>
                    <li><a href="{{url('role/create')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>Add Role</a></li>
                </ul>
            </li>

            {{-- <li>
                <a href="javascript:void(0)" class="has-arrow arrow-c"><i class="fa fa-lock"></i><span>CMS</span></a>
                <ul>
                    <li><a href="{{url('cms/blog')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>Blogs</a></li>
                </ul>
            </li> --}}
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <a href="templateshub.net">&copy; 2021 | DATech.</a>
                        </div>
