        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{{url('employee/create')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>New Employee</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{url('user/list')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>User List</a></li>
                    <li><a href="{{url('employee/create')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>New User</a></li>
                </ul>
            </li>

            <li>
                <a href="javascript:void(0)" class="has-arrow arrow-c"><i class="fa fa-lock"></i><span>Uesr Roles</span></a>
                <ul>
                    <li><a href="{{url('user/list')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>User List</a></li>
                    <li><a href="{{url('employee/create')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>New User</a></li>
                </ul>
