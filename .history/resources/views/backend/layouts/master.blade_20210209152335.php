    ...
    <div id="left-sidebar" class="sidebar ">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{url('client')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>All Projects</a></li>
                    <li><a href="{{url('client/create')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>Add Project</a></li>
                </ul>
            </li>
