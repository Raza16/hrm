    ...
    <div id="left-sidebar" class="sidebar ">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{url('client')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>Client List</a></li>
            ...
            @if(Auth::user()->role_id == 2)
                ...
                <ul>
                    <li><a href="{{url('user')}}"><i class="fa fa-arrow-right" aria-hidden="true"></i>Leave List</a></li>
                </ul>
            </li>
            @endif
