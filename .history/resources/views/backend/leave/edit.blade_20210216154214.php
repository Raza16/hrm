                                            ...
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" class="form-control">
                                                        <option value="pending" {{$leave->leave_type == 'pending' ? 'selected' : ''}}>Casual</option>
                                                        <option value="approved" {{$leave->leave_type == 'approved' ? 'selected' : ''}}>Sick</option>
                                                        <option value="rejected" {{$leave->leave_type == 'rejected' ? 'selected' : ''}}>Sick</option>
                                                    </select>
                                                    @error('status')
