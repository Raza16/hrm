                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($leave->status == 'pending')
                                                                <span class="tag tag-warning ml-0 mr-0">{{$leave->status}}</span>
                                                            @elseif($leave->status == 'process')
                                                                <span class="tag tag-primary ml-0 mr-0">{{$leave->status}}</span>
                                                            @elseif($leave->status == 'completed')
                                                                <span class="tag tag-success ml-0 mr-0" style="background-color:#21ba45">{{$leave->status}}</span>
                                                            @elseif($leave->status == 'terminated')
                                                                <span class="tag tag-success ml-0 mr-0">{{$leave->status}}</span>
                                                            @endif
                                                            {{-- {{$leave->status}} --}}
                                                        </td>
                                                        <td>{{$leave->reason}}</td>
                                                        ...
                                                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                                           <div class="btn-group" role="group">
                                                                ...
                                                                <a class="dropdown-item" href="{{url('leave-list/'.$leave->id.'/edit')}}">Edit</a>
                                                                {{-- <form>
                                                                    <a class="dropdown-item" href="{{url('leave/'.$leave->id)}}">Delete</a>
                                                                </form> --}}
                                                                </div>
                                                            </div>
                                                        </div>
