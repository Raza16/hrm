                                            ...
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" class="form-control">
                                                        <option value="pending" {{$leave->leave_type == 'pending' ? 'selected' : ''}}>Pending</option>
                                                        <option value="approved" {{$leave->leave_type == 'approved' ? 'selected' : ''}}>Approved</option>
                                                        <option value="rejected" {{$leave->leave_type == 'rejected' ? 'selected' : ''}}>Rejected</option>
                                                    </select>
                                                    @error('status')
