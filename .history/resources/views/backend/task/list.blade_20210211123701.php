                                            ...
                                            <tbody class="table-hover ">
                                                @foreach ($tasks as $task)
                                                    <tr>
                                                        ...
                                                        <td>{{$task->task_no}}</td>
                                                        <td>
                                                            @if ($task->priority == 'pending')
                                                                <span class="tag tag-warning ml-0 mr-0">{{$task->priority}}</span>
                                                            @elseif($task->priority == 'process')
                                                                <span class="tag tag-primary ml-0 mr-0">{{$task->priority}}</span>
                                                            @elseif($task->priority == 'completed')
                                                                <span class="tag tag-success ml-0 mr-0" style="background-color:#21ba45">{{$task->priority}}</span>
                                                            @endif
                                                            {{-- {{$task->priority}} --}}
                                                        </td>
