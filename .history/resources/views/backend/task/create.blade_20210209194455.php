                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <form class="card-body" action="{{url('task')}}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @foreach ($employees as $employee)
                                                        <option value="{{$employee->id}}">{{$employee->first_name.''.$employee->middle_name}}</option>
                                                    @endforeach
                                                    </select>
                                                    @error('employee_id')
                                                ...
                                                <div class="form-group">
                                                    <label>Task No</label>
                                                    <input type="text" name="task_no" class="form-control" value="{{old('task_no')}}">
                                                    @error('task_no')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="assign_date" class="form-control" value="{{old('assign_date')}}">
                                                    @error('assign_date')
