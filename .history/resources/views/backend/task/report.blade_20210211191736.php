...
@section('title', 'Task Progress | List')
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">All Tasks Progress</h3>
                                            ...
                                            <tbody class="table-hover ">
                                                @foreach ($taskReport as $tr)
                                                    <tr>
                                                        <td>
                                                            @if ($tr->)
                                                                {{$tr->employee->first_name.' '.$task->employee->middle_name.' '.$task->employee->last_name}}
                                                            @endif
                                                        </td>
                                                        <td>
                                                            @if ($tr->project->title)
                                                        ...
                                                        {{-- <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                                           <div class="btn-group" role="group">
                                                                ...
                                                                <a class="dropdown-item" href="{{url('employee-task/'.$tr->id.'/edit')}}">Edit</a>
                                                                <a class="dropdown-item" href="{{url('employee-task-progress/'.$tr->id.'/task-progress')}}">Submit Task Progress</a>
                                                                </div>
                                                            </div>
                                                            </div> --}}
                                                        </td>
