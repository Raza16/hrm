                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <form class="card-body" action="{{url('task/'.$task->id)}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @foreach ($employees as $employee)
                                                        <option value="{{$employee->id}} {{$task->employee_id == $employee->id ? 'selected' : ''}}">{{$employee->first_name.' '.$employee->middle_name.' '.$employee->last_name}}</option>
                                                    @endforeach
                                                    </select>
                                                    @error('employee_id')
                                                ...
                                                <div class="form-group">
                                                    <label>Task No</label>
                                                    <input type="text" name="task_no" class="form-control" value="{{$task->task_no}}" readonly>
                                                    @error('task_no')
                                                ...
                                                <div class="form-group">
                                                    <label>Note</label>
                                                    <textarea rows="6" name="note" class="form-control">{{$task->note}}</textarea>
                                                    @error('note')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="document" class="form-control" value="{{asset('img/profile-images/'.$employee->profile_image)}}">
                                                    @error('document')
