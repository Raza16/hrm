...
<html lang="zxx">
	<head>
		...
		<!-- Favicon -->
		<link rel="icon" type="image/favicon.png" href="{{asset('img/favicon1.png')}}">
								...
								<div class="row">
									<div class="col-lg-2 col-md-3 col-12">
										...
										<div class="logo">
											...
											<div class="img-logo">
												<a href="{{url('/')}}">
													<img src="{{asset('img/logo1.png')}}" width="120px;" style="margin-top: 5px;margin-bottom: 5px;" alt="#">
												</a>
											</div>
										</div>								
								...
								<div class="logo">
									<div class="img-logo">
										<a class="logo" href="index.html">
											<img class="img-responsive" src="{{asset('img/favicon1.png')}}"  width="150px" alt="logo">
										</a>
									</div>
								</div>
