						...
						<div class="single-news">
							<div class="news-head overlay">
								...
								<ul class="news-meta">
									...
									<li class="date"><i class="fa fa-calendar"></i>{{ \Carbon\Carbon::parse($blog->created_at)->format('j F, Y') }}
									</li>
							...
							<div class="news-body">
								<div class="news-content">
									<h3 class="news-title"><a href="{{url('blog-single/'.$blog->id)}}">{{$blog->title}}</a></h3>
