...
Route::group(['middleware' => ['employee', 'logout']], function () {
    ...
    Route::get('/usertask', [App\Http\Controllers\Employee\UserDashboardController::class, 'dashboard']);

    Route::resource('usertask', App\Http\Controllers\TaskTrackerController::class);
});
