...
Route::get('admin/dashboard', [DashboardController::class, 'dashboard'])->middleware(['auth','admin']);

Route::get('/user_account', [UserDashboardController::class, 'dashboard'])->middleware('employee');
Auth::routes();
