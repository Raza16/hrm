					...
					<div class="col-12">
						<div class="bread-inner">
							...
							<div class="bread-menu">
								<ul>
									{{-- <li><a href="index.php">Bizwheel</a></li>
									<li><a href="blog-single-left.php">Consulting</a></li>
								...
								<div class="blog-single-main">
									...
									<div class="blog-detail">
										...
										<ul class="news-meta">
											...
											<li><i class="fa fa-pencil"></i>{{ \Carbon\Carbon::parse($blog->created_at)->format('j F, Y') }}</li>
										...
										{{-- <div class="row blog-space">
											<div class="col-lg-6">
												<img src="{{asset('img/blog-side.jpg')}}" alt="#">
											</div>
											<div class="col-lg-6">
