		...
		<header class="header">
								...
								<div class="row">
									<div class="col-lg-2 col-md-3 col-12">
										...
										<div class="logo">
											...
											<div class="img-logo">
												<a href="index.php">
													<img src="img/logo.png" width="120px;" style="margin-top: 5px;margin-bottom: 5px;" alt="#">
												</a>
											</div>
										</div>								
													...
													<div class="nav-inner">	
														<div class="menu-home-menu-container">
															...
															<li><a href="index.php">Home</a></li>
																<li class="icon-active"><a href="services.php">Our Services <i class="fa fa-angle-down"></i></a>
																<ul class="sub-menu">
																		<li><a href="single-services.php">Single Services</a></li>
																	</ul>
															</li>
																<li class="icon-active"><a href="portfolio.php">Our Portfolio <i class="fa fa-angle-down"></i></a>
																<ul class="sub-menu">
			...
			<div class="sidebar-popup">
				...
				<div class="single-content">
					...
					<!-- Social Icons -->
					<ul class="social">
						<li><a href="#"><i class="fa fa-facebook" style="padding-top:8px;"></i></a></li>
						<li><a href="#"><i class="fa fa-twitter" style="padding-top:8px;"></i></a></li>
						<li><a href="#"><i class="fa fa-linkedin" style="padding-top:8px;"></i></a></li>
						<li><a href="#"><i class="fa fa-dribbble" style="padding-top:8px;"></i></a></li>
					</ul>
				</div>
				<div class="single-content">
