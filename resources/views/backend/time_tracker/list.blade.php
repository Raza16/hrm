                                        ...
                                        <table class="datatable table table-striped table-bordered" style="width:100%">
                                            ...
                                            <tbody class="table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$time_tracker->checkout ? date('j F, Y | g:i a', strtotime($time_tracker->checkout)) : '--missing--'}}</td>
                                                    <td>{{$time_tracker->total_hours ? $time_tracker->total_hours : '--missing--'}}</td>
                                                    <td>{{$time_tracker->break_hours ? $time_tracker->break_hours : '--missing--'}}</td>
