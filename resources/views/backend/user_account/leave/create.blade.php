                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <form class="card-body" action="{{url('leave')}}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="from_date" id="from-date" class="form-control" value="{{old('from_date')}}">
                                                    @error('from_date')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-blue">For 1 day leave To-Date same as From-Date</small>
                                                    <input type="date" name="to_date" id="to-date" class="form-control" value="{{old('to_date')}}">
                                                    @error('to_date')
                                                ...
                                                <div class="form-group">
                                                    <label>Days</label>
                                                    <input type="text" name="days" id="days" class="form-control" readonly value="{{old('days')}}">
                                                    @error('days')
                                                ...
                                                <div class="form-group">
                                                    <label>Reason</label>
                                                    <textarea type="text" rows="6" name="reason" class="form-control">{{old('reason')}}</textarea>
                                                    @error('reason')
                                                    <p><small class="text-danger">{{ $errors->first('reason') }}</small></p>
                                                    @enderror
                                                </div>
                                            </div>
                                        </div>
