                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($leave->status == 'pending')
                                                                <span class="tag tag-warning ml-0 mr-0">Pending</span>

                                                            @elseif($leave->status == 'approved')
                                                                <span class="tag tag-success ml-0 mr-0" style="background-color:#21ba45">Approved</span>

                                                            @elseif($leave->status == 'rejected')
                                                                <span class="tag tag-success ml-0 mr-0">Rejected</span>
                                                            @endif
                                                            {{-- {{$leave->status}} --}}
                                                        </td>
                                                        <td>{{$leave->reason}}</td>
