                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 first-column">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="editor" name="description" class="form-control no-resize" placeholder="description...">{{ $blog->description }}</textarea>
                                                    @error('description')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="4" name="meta_description" class="form-control no-resize" placeholder="Meta description...">{{ $blog->meta_description }}</textarea>
